...
class CvManager:
    ...
    def __compute_percent_cv(self, channel):
        value = 100-int((self.cvs_data[channel].cvs_bound[MAX]-self.__raw_values[channel])/(self.cvs_data[channel].cvs_bound[MAX]-self.cvs_data[channel].cvs_bound[MIN])*100)
